...
;$(function(){
    ...
    //侧栏
	$(".container .sidenav_parent").on("click",".ficon",function(){
        if($(this).parent().hasClass('isopen')){
            $(this).parent().next().hide();
            $(this).parent().find('.ficon').addClass('fa-plus-square').removeClass('fa-minus-square');
            $(this).parent().removeClass('isopen');
        }else{
            $(this).parent().addClass('isopen');
            $(this).parent().next().show();
            $(this).parent().find('.ficon').removeClass('fa-plus-square').addClass('fa-minus-square');
        }
    })
    //部门展开侧栏

   /* $(".container #deptlist").on("click",".ficon",function(){
    ...
    $(".container #deptlist").on("click","a",function(){
