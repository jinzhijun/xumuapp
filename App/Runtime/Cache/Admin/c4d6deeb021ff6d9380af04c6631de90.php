    ...
    position: relative;
				...
				<div class="widget-box transparent" id="recent-box">
					<div class="widget-header">
						...
						<div class="widget-toolbar no-border">
							<ul class="nav nav-tabs" id="recent-tab">
								...
								<li>
									<a  href="<?php echo U(CONTROLLER_NAME . '/gindex');?>">列表</a>
								</li>
								<?php if($list["id"] == '' ): ?><li class="active">
									<a href="<?php echo U(CONTROLLER_NAME . '/gadd');?>">添加</a>
								</li>
								<?php else: ?>
								<li class="active">
									<a href="#">修改</a>
											...
											<br>
					<?php if($list["id"] != '' ): ?><form role="form" id="form1" method="post" enctype="multipart/form-data" action="<?php echo U(CONTROLLER_NAME . '/gsave_data');?>">
							<?php else: ?>
					...
					<div class="form-group">
                            <label class="tar col-sm-3 control-label no-padding-right" for="form-field-1">标题</label>

                            <div class="col-sm-9">
                                <input value="<?php echo ($list["title"]); ?>" type="text" id="title" placeholder="" name="title" class="col-xs-10 col-sm-5" />
                            </div>
                       ...
                       <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style=" text-align: right;">缩略图</label>
                            <div class="col-sm-7" >
