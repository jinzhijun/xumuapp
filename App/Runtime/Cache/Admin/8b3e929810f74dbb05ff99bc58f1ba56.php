        ...
        <div class="row">  	
              ...
              <div class="widget-header">
                <div class="widget-toolbar no-border">
                  ...
                  <ul class="nav nav-tabs" id="recent-tab">
                    ...
                    <li class="active"><a href="<?php echo U(CONTROLLER_NAME.'/index');?>">会员列表</a></li>
                  ...
                  <div class="col-xs-12"> 
                      ...
                      <table id="sample-table-1"
                        ...
                        <tbody>
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td class="hidden-480"><img src="<?php echo ($vo["head"]); ?>" width="50" /></td>
                               <td ><?php if($vo['pass_initialize'] == 0 ): echo ($vo["pass_text"]); ?>
                                 <?php else: ?>
                             		    已修改初始密码<?php endif; ?>
                                  </td>
                              ...
                              <td class="hidden-480"><span
																class="label label-sm label-warning"><?php echo (date("Y-m-d
                                H:i:s",$vo["date"])); ?></span></td>
                                ...
                                <td >
                                    ...
                                    <input type="text" name="add_score" id="add_score_<?php echo ($vo['id']); ?>" value="" style="text-align:right;width:60px;">
                                    <button type="button" class="btn btn-sm btn-primary" style="cursor:pointer" onclick="member_adit('<?php echo ($vo["id"]); ?>','<?php echo ($vo["name"]); ?>')">保存</button>
                                </td>
                              ...
                              <td><div
                                  ...
                                  <button type="button" class="btn btn-xs btn-danger"
																		data-toggle="modal" data-target=".bs-example-modal-sm"> <i class="icon-trash bigger-120 del"
																			data-id="<?php echo ($vo["id"]); ?>">删除</i> </button>
																			<a type="button" href="<?php echo u(CONTROLLER_NAME . '/password');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-success "><span class="icon-lock bigger-120 ">修改密码</span> </a>
																			<!-- <a type="button" href="<?php echo u(CONTROLLER_NAME . '/head');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-warning "><span class="icon-picture bigger-120 ">头像设置</span> </a> -->
                                </div></td>	
                    ...
                    <script type="text/javascript">
                        ...
                        function member_adit(id,name){
                            ...
                            var h=70;
                            $.ajax({
                                url:"<?php echo U('User/sign_change');?>", // 表单提交的地址
                                type: 'POST',
                                dataType: 'json',
         ...
         //设置密码
          $('.set_pass').click(function(){
        	  ...
        	  //alert(data);
		  $.ajax({
			     url:"<?php echo u(CONTROLLER_NAME . '/password');?>",
			     type:"POST",
			     dataType:"json",
			     data:data,
			     success:function(res){
