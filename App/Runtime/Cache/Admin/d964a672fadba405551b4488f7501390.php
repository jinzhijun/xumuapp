             ...
             class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td><a class="example-image-link" href="<?php echo ($vo["main_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["main_img"]); ?>" alt="营业执照"></a></td>
                                <td><a class="example-image-link" href="<?php echo ($vo["idr_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["idr_img"]); ?>" alt="身份证正面"></a></td>
                                <td><a class="example-image-link" href="<?php echo ($vo["idl_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["idl_img"]); ?>" alt="身份证反面"></a></td>


                                <td><a class="example-image-link" href="<?php echo ($vo["storer1_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["storer1_img"]); ?>" alt="门店外1"></a></td>
                                <td><a class="example-image-link" href="<?php echo ($vo["storer2_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["storer2_img"]); ?>" alt="门店外2"></a></td>
                                <td><a class="example-image-link" href="<?php echo ($vo["storel1_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["storel1_img"]); ?>" alt="门店内1"></a></td>


                                <td><a class="example-image-link" href="<?php echo ($vo["storel2_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["storel2_img"]); ?>" alt="门店内2"></a></td>
                                <td><a class="example-image-link" href="<?php echo ($vo["storel3_img"]); ?>" data-lightbox="content" ><img class="example-image" style="width:50px;height:50px;" src="<?php echo ($vo["storel3_img"]); ?>" alt="门店内3"></a></td>
