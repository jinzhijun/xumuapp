						...
						<div class="widget-toolbar no-border">
							<ul class="nav nav-tabs" id="recent-tab">
								...
								<?php if($list["id"] == '' ): ?><li class="active">
									<a href="<?php echo U(CONTROLLER_NAME . '/xieyi');?>">添加</a>
								</li>
								<?php else: ?>
								<li class="active">
									<a href="#">修改</a>
											...
											<br>
					<?php if($list["id"] != '' ): ?><form role="form" id="form1" method="post" enctype="multipart/form-data" action="<?php echo U(CONTROLLER_NAME . '/gsave_xieyi');?>">
							<?php else: ?>
