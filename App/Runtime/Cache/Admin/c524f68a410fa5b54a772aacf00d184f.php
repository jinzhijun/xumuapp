              ...
              <div class="widget-header">
                <div class="widget-toolbar no-border">
                  <ul class="nav nav-tabs" id="recent-tab">
                    ...
                    <!--<li><a href="<?php echo U(CONTROLLER_NAME.'/gadd');?>">添加</a> </li>-->
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="main-container" id="main-container"> 
              ...
              <div>
                <form action="<?php echo u(CONTROLLER_NAME.'/gindex');?>">
                  <input style="margin: 0px 0 0 0; float: left;" value="<?php echo ($title); ?>"
                ...
                <div class="row">
                  <div class="col-xs-12"> 
                        ...
                        <tbody>
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td class="center"><label>
                                ...
                                <td class="hidden-480"><?php echo ($vo["proname"]); ?>1111</td>
                                ...
                                <td>
                                    <select id="check_6916" onchange="check(this.value,'<?php echo ($vo[id]); ?>')">
                                        <option value="1" <?php if($vo["type"] == 1): ?>selected<?php endif; ?> >未发货</option>
                                        <option value="2" <?php if($vo["type"] == 2): ?>selected<?php endif; ?> >已发货</option>
                                        <option value="3" <?php if($vo["type"] == 3): ?>selected<?php endif; ?> >已收货</option>
                                    </select>
                                </td>

                                <td>
                                    <input type="text" name="note" id="note_<?php echo ($vo['id']); ?>"   placeholder="如(申通快递3310265414887)"   value="<?php echo ($vo["note"]); ?>" style="text-align:right;width:200px;">
                                    <button type="button" class="btn btn-sm btn-primary" style="cursor:pointer" onclick="member_adit('<?php echo ($vo["id"]); ?>')">保存</button>
                                </td>
                              ...
                              <td>
                                  ...
                                  <button type="button" class="btn btn-xs btn-danger"
                                            data-toggle="modal" data-target=".bs-example-modal-sm"> <i class="icon-trash bigger-120 del"
                                                                                                       data-id="<?php echo ($vo["id"]); ?>"    onclick="return confirmurl('<?php echo u(CONTROLLER_NAME.'/gdelete_data',array('id'=>$vo['id']));?>','您确定要删除吗?')">删除</i> </button>
                                </div></td>
                    ...
                    function member_adit(id){
                        ...
                        var h=70;
                        $.ajax({
                            url:"<?php echo U('ProOrder/order_change');?>", // 表单提交的地址
                            type: 'POST',
                            dataType: 'json',
