    ...
    <div class="main-content">
      <div class="page-content">
              ...
              <div class="widget-header">
                <div class="widget-toolbar no-border">
                  <ul class="nav nav-tabs" id="recent-tab">
                    ...
                    <li class="active"><a href="<?php echo U(CONTROLLER_NAME.'/expend');?>">列表</a></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        try{ace.settings.check('main-container' , 'fixed')}catch(e){}
              ...
              <div>
                <form action="<?php echo u(CONTROLLER_NAME.'/expend');?>">
                  <input style="margin: 0px 0 0 0; float: left;" value="<?php echo ($username); ?>"
                      type="text" id="username" placeholder="账号" name="username" />
                          ...
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td><span style="color:#999;"><?php echo ($vo["id"]); ?></span></td>
                               <td><?php echo ($vo["username"]); ?></td>
                                ...
                                <td><?php if($vo['type'] == 1): ?>手动添加 <?php elseif($vo['type'] == 2): ?>生日积分<?php elseif($vo['type'] == 3): ?>大转盘<?php elseif($vo['type'] == 4): ?>商城积分兑换商品<?php elseif($vo['type'] == 5): ?>业务积分兑换商城积分<?php elseif($vo['type'] == 6): ?>广告积分<?php endif; ?></td>
