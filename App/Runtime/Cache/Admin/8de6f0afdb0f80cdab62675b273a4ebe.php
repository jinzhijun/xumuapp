              ...
              <div class="widget-header">
                <div class="widget-toolbar no-border">
                  ...
                  <ul class="nav nav-tabs" id="recent-tab">
                    ...
                    <li class="active"><a href="<?php echo U(CONTROLLER_NAME.'/index');?>">群组列表</a></li>
            ...
            <div class="main-container" id="main-container"> 
              ...
              <div>
                <form action="<?php echo u(CONTROLLER_NAME.'/index');?>">
                  <input style="margin: 0px 0 0 0; float: left;" value="<?php echo ($name); ?>" type="text" id="name" placeholder="" name="name" />
                      ...
                      <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td class="hidden-480"><?php echo ($vo["market_name"]); ?></td>
                              <td class="hidden-480"><span class="label label-sm label-warning"><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></span></td>
                              <!--td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group"> 
								<a href="<?php echo u(CONTROLLER_NAME . '/info',array('id'=>$vo['id']));?>" class="btn btn-xs btn-info"> 
