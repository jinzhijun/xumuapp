...
<div class="system-messageq" style="background: #f7f7f7">
	<!--p style="height:35px;background:<?php if($message !== '' ){ echo 'url(/Public/img/msg_top_bg_new.png)'; }else{ echo 'url(/Public/img/msg_top_bg.png)'; } ?> #ccc;padding-left:10px;line-height:35px;color:white">提醒</p-->
	...
	<div style="padding:24px;">
		<?php if(isset($message)): ?><div class="success"><img style="margin-right: 9px;padding-top:10px;" src="/Public/img/success.png"><span><?php echo($message); ?></span></div>
		<?php else: ?>		
		<div class="error"><img style="margin-right: 9px;padding-top:10px;" src="/Public/img/error.png" style="cursor:pointer;"><span style="padding-top:0px;"><?php echo($error); ?></div><?php endif; ?>
