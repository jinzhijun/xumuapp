...
<div class="main-container" id="main-container">
  <div class="main-container-inner"> <a class="menu-toggler" id="menu-toggler" href="#"> <span
        ...
        try{ace.settings.check('main-container' , 'fixed')}catch(e){}
              ...
              <div class="main-container-inner">
                ...
                <div class="row">
                  <div class="col-xs-12"> 
                    <!-- PAGE CONTENT BEGINS -->
                     <!--<a href="#" class="all_val"  data-toggle="modal" data-target="#myModal2"  onClick="batchDelete('info','<?php echo U($controller.'/batchDelete');?>');">批量删除</a>-->
             ...
             class="table table-striped table-bordered table-hover">
                    ...
                    onChange="show_change('<?php echo ($vo['id']); ?>')"
                              ...
                              <td><div
                                  class="visible-md visible-lg hidden-sm hidden-xs btn-group"> <a
                                    href="<?php echo u(CONTROLLER_NAME . '/gsave_data');?>?id=<?php echo ($vo["id"]); ?>"
                ...
                function() {
                  list.push($(this).val());
                       ...
                       var data = "list="+list.join(',');
                        $.ajax({
                       url:"<?php echo u(CONTROLLER_NAME . '/gdelete_data');?>",
                       type:"POST",
                       dataType:"json",
                       data:data,
                       success:function(res){
    ...
    function show_change(id){
      var show = document.getElementById("show_"+id).checked == true ? '1':'0';
       $.ajax({
        url:"<?php echo U(CONTROLLER_NAME . '/gshow_change');?>", // 表单提交的地址
        type: 'POST',
        dataType: 'json',
        data:'id='+id+'&status='+show, // 表单提交的数据
        success:function(res){
