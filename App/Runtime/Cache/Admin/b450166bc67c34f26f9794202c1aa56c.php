                            ...
                            <div class="widget-header">
                                <div class="widget-toolbar no-border">
                                    <ul class="nav nav-tabs" id="recent-tab">
                                        <li class="active"><a href="<?php echo U(CONTROLLER_NAME.'/index');?>">关注列表</a></li>
                                ...
                                <table id="sample-table-1"
                                    ...
                                    <tr>
                                       <!-- <th class="center"><label >
                                        ...
                                        <td>用户名称</td>
                                        <td>用户头像</td>
                                        <td style="width:150px;">关注产品总数</td>
                                       <!-- <td>是否启用</td>
                                        <td>创建时间</td>
                                        -->
                                        <td>操作</td>
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><img src="<?php echo ($vo["head"]); ?>" width="70" /></td>
                                            <td class="hidden-480">
                                                <?php if($vo["count"] == 0): ?>未关注过任何产品<?php else: echo ($vo["count"]); endif; ?></td>
                                            <td>
                                                <a  <?php if($vo["count"] == 0): ?>disabled<?php endif; ?> href="<?php echo u(CONTROLLER_NAME . '/check');?>?id=<?php echo ($vo["id"]); ?>"
                                                    class="btn btn-xs btn-info">查看关注产品详细</i> </a>
                                             </td>
