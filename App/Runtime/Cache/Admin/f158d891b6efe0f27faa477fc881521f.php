                            ...
                            <div class="widget-header">
                                <div class="widget-toolbar no-border">
                                    <ul class="nav nav-tabs" id="recent-tab">
                                        <li class="active"><a
                                                href="<?php echo U(CONTROLLER_NAME . '/index');?>">列表</a></li>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-responsive">
                                            <table id="sample-table-1"
                                                ...
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                        ...
                                                        <td><img src="<?php echo ($vo["main_img"]); ?>" width="60" /></td>
                                                        <td class="hidden-480"><?php echo ($vo["class"]); ?></td>
                                                        <td><a href="<?php echo U(CONTROLLER_NAME . '/proPhoto');?>?id=<?php echo ($vo['id']); ?>">[产品相册管理]</a></td>
                                                        ...
                                                        <td><div
                                                                ...
                                                                title="编辑" href="<?php echo u(CONTROLLER_NAME . '/edit_pro');?>?id=<?php echo ($vo["id"]); ?>"
                                                        ...
                                                        <a onclick="attention(<?php echo ($vo["id"]); ?>);" >关注</a></td>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function attention(id){
                                                $.ajax({
                                                    url: "<?php echo u('attention/attention');?>",
                                                    type: "POST",
                                                    dataType: "json",
                                                    data: "id="+id,
                                                    success: function (res) {
