 ...
 */
class ApiEasemobAction  {echo 99;exit;
	
	private $app_key = 'yxf-jgs#yxfgroup1';
    private $client_id = 'YXA6VEwjEDbCEeagG1W8s2itJg';
    private $client_secret = 'YXA6DXMo9CBvZCzoJLMJPVJxhk9j0IU';
    private $url_f = "https://a1.easemob.com/yxf-jgs/yxfgroup1";
    private $org_name = 'yxf-jgs';
    private $app_name = 'yxfgroup1';
